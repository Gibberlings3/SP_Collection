...
set "compatible_games=%bg2%, %bgt%, %tutu%, %bgee%, %bgiiee%, %iwdee%, %iwd-in-bg2%, or %eet%"
...
set iconv_folder=%mod_folder%\lang\iconv
...
REM /* MODIFY: if the files in your mod haven't been lowercased, setting the variable below to 1 will do that before creating the packages */
